    ...
    <div class="row">
        ...
        <div class="col-sm-2">
            <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" id="input-name" type="text" placeholder="{{ __('Nombre de Usuario')}}" value="{{ old('name', $user->name)}}" required="true" aria-required="true" />
                @if ($errors->has('name'))
    ...
    <div class="row">
        ...
        <div class="col-sm-2">
            <div class="form-group{{ $errors->has('email') ? ' has-danger' : '' }}">
                <input class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" id="input-email" type="email" placeholder="{{ __('Correo') }}" value="{{ old('email', $user->email)}}" required="true" aria-required="true" />
                @if ($errors->has('email'))
    ...
    <div class="row">
        ...
        <div class="col-sm-2">
            <div class="form-group{{ $errors->has('password') ? ' has-danger' : '' }}">
                <input class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" name="password" id="input-password" type="text" placeholder="{{ __('Contraseña') }}" value="{{ old('password', $user->password)}}" required="true" aria-required="true" />
    ...
    <div class="row">
        ...
        <div class="col-sm-2">
            <div class="form-group{{ $errors->has('confirm_password') ? ' has-danger' : '' }}">
                <input class="form-control{{ $errors->has('confirm_password') ? ' is-invalid' : '' }}" name="confirm_password" id="input-confirm_password" type="text" placeholder="{{ __('Confirmar contraseña') }}" value="{{ old('confirm_password', $user->confirm_password)}}" required="true" aria-required="true" />
