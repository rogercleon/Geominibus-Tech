            ...
            <div class="row">
                ...
                <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('Fecha') ? ' has-danger' : '' }}">
                        <input class="form-control{{ $errors->has('Fecha') ? ' is-invalid' : '' }}" type="date" name="Fecha" id="input-Fecha" value="{{ old('Fecha', $horario->Fecha) }}" required readonly />
                        @if ($errors->has('Fecha'))
            ...
            <div class="row">
                ...
                <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('Hora') ? ' has-danger' : '' }}">
                        <input class="form-control{{ $errors->has('Hora') ? ' is-invalid' : '' }}" type="time" name="Hora" id="input-Hora" value="{{ old('Hora', $horario->Hora) }}" required readonly />
                        @if ($errors->has('Hora'))
...
<style>
    ...
    /* Tamaño cuadrado para los botones */
    .seat-button {
        border-radius: 10px;
        font-weight: bold;
        width: 80px;
    ...
    .btn-secondary {
        ...
        /* Color por defecto con opacidad para que la imagen se vea */
    }

    .btn-danger {
        background-color: rgba(220, 53, 69, 0.7);
        /* Color rojo para el asiento 1 con opacidad */
    }

    .btn-success {
        background-color: rgba(40, 167, 69, 0.7);
        /* Color verde para el asiento seleccionado con opacidad */
    }
</style>
